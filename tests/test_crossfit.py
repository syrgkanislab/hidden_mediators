...
def test_fit_predict():
    ...
    cvpreds = fit_predict(X, Z, MultiTaskLassoCV(random_state=123), MultiTaskLasso(random_state=123), 5, True, True, -1, 0)
    ...
    cvpreds = fit_predict(X, Z, MultiTaskLassoCV(random_state=123), MultiTaskLasso(random_state=123), 5, False, True, -1, 0)
